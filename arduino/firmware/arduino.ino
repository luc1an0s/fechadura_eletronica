...
void loop() {
  ...
  if (Serial.available()) {
    ...
    if (comando.startsWith("CADASTRO:")) cadastrarUsuario(comando); criamos a logica do id unico ou deixa bagunçado? vamo ver ent, beleza, vou tacar outra ia dnv, essa estressou eu acho pq tava delirando mto
...
} me perdi kkkkkk, n to achando o laço do id e senha